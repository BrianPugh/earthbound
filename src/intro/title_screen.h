...
/* Yield-free one-shot setup for the title screen (PPU/BG/OAM config, graphics
   ...
   pushing GAME_MODE_TITLE_SCREEN (init_intro's title scene and CC_1F_41 case 10,
   GAME_MODE_SPECIAL_EVENT). The title screen pops 0 = timed out (attract mode),
   1 = user pressed Start/A/B. Ported from SHOW_TITLE_SCREEN (show_title_screen.asm). */
