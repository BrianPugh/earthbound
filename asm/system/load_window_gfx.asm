...
@CHAR_LOOP_CHECK:
	...
	BCCL @RENDER_NAME
	LDY #0
	BRA @BORDER_LOOP_CHECK
@INIT_BORDER_TILE:
	LOADPTR BUFFER + $70, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL03
	LDX #0
	BRA @BORDER_ROW_LOOP_CHECK
@BLIT_BORDER_ROW:
	LDA [@LOCAL07]
	STA @LOCAL04
	XBA
	...
	MOVE_INT @VIRTUAL06, @LOCAL03
	INX
@BORDER_ROW_LOOP_CHECK:
	CPX #8
	BCC @BLIT_BORDER_ROW
	INY
@BORDER_LOOP_CHECK:
	CPY #32
	BCC @INIT_BORDER_TILE
	LOADPTR BUFFER + $2C00, @LOCAL02
	LOADPTR STATUS_EQUIP_WINDOW_TEXT_2, @LOCAL07
	JMP @EQUIP_TEXT_LOOP_CHECK
@PROCESS_EQUIP_CHAR:
	CMP #32
	BEQL @NEXT_EQUIP_CHAR
	STA @VIRTUAL02
	AND #$FFF0
	CLC
	ADC @VIRTUAL02
...
@NEXT_EQUIP_CHAR:
	...
	INC @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL07
@EQUIP_TEXT_LOOP_CHECK:
	LDA [@LOCAL07]
	BNEL @PROCESS_EQUIP_CHAR
	END_C_FUNCTION
