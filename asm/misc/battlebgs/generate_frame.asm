...
@CYCLE3_SWAP_COLOR:
	...
	LDA @VIRTUAL02
	CMP @VIRTUAL04
	BCC @CYCLE3_CHECK_REVERSE
	LDA @VIRTUAL02
	SEC
	SBC @VIRTUAL04
	STA @VIRTUAL02
	STA @LOCAL03
	BRA @CYCLE3_AFTER_WRAP
@CYCLE3_CHECK_REVERSE:
	LDA @LOCAL01
	PHA
	LDA @VIRTUAL02
	PLY
...
@CHECK_SCROLLING:
	...
	TAX
	LDA __BSS_START__,X
	BEQL @UPDATE_POSITIONS
	DEC
	STA __BSS_START__,X
	BNEL @UPDATE_POSITIONS
	LDA @LOCAL07
	CLC
