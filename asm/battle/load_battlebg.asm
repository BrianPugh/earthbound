...
@ADJUST_TILEMAP_M9:
	...
	INC
	STA @LOCAL06
@ADJUST_TILEMAP_M9_CHECK:
	CMP #$0800
	BCC @ADJUST_TILEMAP_M9
	...
	LDA #0
	STA @LOCAL0A
	BRA @ADJUST_TILEMAP_L2_4BPP_CHECK
@ADJUST_TILEMAP_L2_4BPP:
	STORE_INT1632 @VIRTUAL06
	CLC
	VAR_ADD_CONST_INT_ASSIGN BUFFER + 1, @VIRTUAL06
	SEP #PROC_FLAGS::ACCUM8
	...
	INC
	STA @LOCAL0A
@ADJUST_TILEMAP_L2_4BPP_CHECK:
	CMP #$0800
	BCC @ADJUST_TILEMAP_L2_4BPP
...
@ADJUST_TILEMAP_M1:
	...
	INC
	STA @LOCAL0A
@ADJUST_TILEMAP_M1_CHECK:
	CMP #$0800
	BCC @ADJUST_TILEMAP_M1
	LOADPTR BUFFER, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL07
	COPY_TO_VRAM1P @VIRTUAL06, $5C00, $800, 0
	.A16
	...
	LDA #0
	STA @LOCAL0A
	BRA @ADJUST_TILEMAP_L2_M1_CHECK
@ADJUST_TILEMAP_L2_M1:
	STORE_INT1632 @VIRTUAL06
	CLC
	VAR_ADD_CONST_INT_ASSIGN BUFFER + 1, @VIRTUAL06
	SEP #PROC_FLAGS::ACCUM8
	...
	INC
	STA @LOCAL0A
@ADJUST_TILEMAP_L2_M1_CHECK:
	CMP #$0800
	BCC @ADJUST_TILEMAP_L2_M1
