...
.ENDIF
	...
	LDX #0
	STX @LOCAL05
	JMP @INIT_SPRITEMAP_CHECK
@INIT_SPRITEMAP_ENTRY:
	...
	REP #PROC_FLAGS::ACCUM8
	LOADPTR BATTLE_SPRITE_TILE_GRID, @VIRTUAL06
	LDA @LOCAL04
	TAY
	INY
	TXA
	...
	INX
	STX @LOCAL05
@INIT_SPRITEMAP_CHECK:
	CPX #16
	BCCL @INIT_SPRITEMAP_ENTRY
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL09
	STA @VIRTUAL04
	OPTIMIZED_MULT @VIRTUAL04, 5
...
@DECOMPRESS_TILE_ROW:
	...
	ASL
	TAX
	LDA f:BATTLE_SPRITE_BUFFER_OFFSETS,X
	CLC
	ADC @VIRTUAL0A
	STA @VIRTUAL0A
