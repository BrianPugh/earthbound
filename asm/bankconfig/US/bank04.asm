...
.INCLUDE "text/vwf/initialize_existing_name_vwf.asm"
...
.INCLUDE "text/print_text_with_word_splitting.asm"
...
.INCLUDE "text/window/print_money_in_window.asm"
...
.INCLUDE "misc/get_pad_state.asm"
...
.INCLUDE "intro/render_party_member_name.asm"
