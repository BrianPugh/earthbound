...
.INCLUDE "text/menu/build_command_menu.asm"
...
.INCLUDE "inventory/select_escargo_express_item.asm"
...
.INCLUDE "text/menu/overworld_psi_menu.asm"
...
.INCLUDE "text/menu/display_psi_ability_details.asm"
...
.INCLUDE "text/render_dont_care_name.asm"
