...
COMPRESSED_PHOTOGRAPH_PALETTES:
...
.INCLUDE "misc/cycle_battle_target.asm"
...
.IF .DEFINED(USA)
	TITLE_SCREEN_SPRITE_PALETTE:
		LOCALEBINARY "E1AE7C.bin.lzhal"

	TITLE_SCREEN_BG1_DATA:
		LOCALEBINARY "E1AE83.bin.lzhal"

	TITLE_SCREEN_BG2_DATA:
