...
.INCLUDE "text/find_free_window_slot.asm"
...
.INCLUDE "text/window/render_window_frame-jp.asm"

.INCLUDE "text/clear_battle_menu_character_indicator-jp.asm"
...
.INCLUDE "text/window/free_window_text_row-jp.asm"

.INCLUDE "text/window/scroll_window_up-jp.asm"

.INCLUDE "text/window/write_tile_to_window-jp.asm"
...
.INCLUDE "text/print_currency_value.asm"
...
.INCLUDE "text/menu/add_positioned_menu_option-jp.asm"
...
.INCLUDE "text/menu/layout_menu_options-jp.asm"
...
.INCLUDE "text/menu/cc_add_menu_option_with_callback-jp.asm"
...
.INCLUDE "text/is_escargo_express_full-jp.asm"

.INCLUDE "misc/escargo_express_store.asm"

.INCLUDE "misc/escargo_express_move.asm"

.INCLUDE "inventory/remove_escargo_express_item-jp.asm"
...
.INCLUDE "text/print_character_name-jp.asm"
...
.INCLUDE "text/window/display_status_window-jp.asm"

.INCLUDE "misc/inventory_get_item_name.asm"

.INCLUDE "text/menu/selection_menu_with_focus.asm"

.INCLUDE "inventory/select_escargo_express_item-jp.asm"
...
.INCLUDE "inventory/store/open_store_menu-jp.asm"

.INCLUDE "misc/get_item_type.asm"

.INCLUDE "inventory/equipment/display_equipment_menu-jp.asm"

.INCLUDE "inventory/equipment/display_character_equipment_stats-jp.asm"

.INCLUDE "inventory/equipment/show_equipment_and_stats.asm"

.INCLUDE "inventory/equipment/equipment_change_menu-jp.asm"

.INCLUDE "text/window/display_money_window-jp.asm"

.INCLUDE "inventory/equipment/open_equipment_menu-jp.asm"
...
.INCLUDE "text/menu/overworld_psi_menu-jp.asm"

.INCLUDE "text/menu/display_psi_description.asm"

.INCLUDE "text/menu/open_status_menu-jp.asm"
...
.INCLUDE "battle/ui/battle_item_menu-jp.asm"
...
.INCLUDE "text/clear_battle_menu_character_indicator_far-jp.asm"
...
.INCLUDE "text/render_naming_character-jp.asm"

.INCLUDE "text/render_dont_care_name-jp.asm"
...
.INCLUDE "text/window/preview_window_flavour-jp.asm"
...
.INCLUDE "intro/file_select/show_file_select_menu-jp.asm"

.INCLUDE "text/show_file_copy_dialog-jp.asm"

.INCLUDE "text/confirm_file_delete-jp.asm"
