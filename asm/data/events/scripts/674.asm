...
EVENT_674_ENTRY_2:
	...
	EVENT_MOVEMENT_CMD_SET_EVENT_FLAG EVENT_FLAG::FLG_ANIM_PORT_6
...
EVENT_674_ENTRY_4:
	...
	EVENT_START_TASK .LOWORD(ANIMATE_FOUNTAIN_TASK)
...
ANIMATE_FOUNTAIN_TASK:
	...
	EVENT_PAUSE 1*FIFTEENTH_OF_A_SECOND
	EVENT_SHORTCALL_CONDITIONAL_NOT .LOWORD(ANIMATE_FOUNTAIN_TASK)
