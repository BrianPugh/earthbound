...
EVENT_351:
	...
	EVENT_SET_DIRECTION
	EVENT_START_TASK .LOWORD(@ROTATE_AND_DISPLAY_TASK)
	EVENT_LOOP $0F
...
@WAIT_FOR_FACING_UP:
	...
	EVENT_SHORTCALL_CONDITIONAL_NOT .LOWORD(@WAIT_FOR_FACING_UP)
	EVENT_END_LAST_TASK
	EVENT_PAUSE $10*FRAMES
	EVENT_WRITE_DWORD_WRAM .LOWORD(POST_TELEPORT_CALLBACK), UNDRAW_FLYOVER_TEXT
	EVENT_YIELD_TO_TEXT
	EVENT_HALT
@ROTATE_AND_DISPLAY_TASK:
	...
	EVENT_SHORTJUMP .LOWORD(@ROTATE_AND_DISPLAY_TASK)
