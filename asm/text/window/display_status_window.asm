...
@PROCESS_AFFLICTION:
	...
	LDX @LOCAL02
	TXA
	BEQ @AFFLICTION_TYPE_0
	CMP #1
	BEQ @AFFLICTION_TYPE_1
	CMP #5
	BEQ @AFFLICTION_TYPE_5
	BRA @AFTER_AFFLICTIONS
@AFFLICTION_TYPE_0:
