...
PATHFIND_TO_PARTY_LEADER:
	...
	TAY
	STY @LOCAL09
	LOADPTR ENTITY_COLLISION_X_OFFSET, @LOCAL08
	LDA @LOCAL0C
	CLC
	...
	TAX
	LOADPTR ENTITY_COLLISION_Y_OFFSET, @VIRTUAL0A
	LDA (@LOCAL07)
	ASL
	STA @LOCAL06
	LOADPTR SPRITE_HITBOX_ENABLE_TABLE, @VIRTUAL06
	...
	LDX #1
	LDA @LOCAL0B
	JSR CALCULATE_PATHFINDING_TARGETS
	LDA @VIRTUAL02
	STA @LOCAL00
	LDA #1
	STA @LOCAL01
	...
	LDX #1
	LDA @LOCAL0B
	JSR INITIALIZE_PATHFINDING_FOR_ENTITIES
	STA @LOCAL0C
	CMP #0
	BNEL @DONE
