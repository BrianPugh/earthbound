...
CREATE_ENTITY:
	...
	STX @LOCAL09
	LDA DEBUG
	BEQ @CHECK_DEBUG_MODE
	LDA @LOCAL0B
	CMP #$FFFF
	BNE @CHECK_DEBUG_MODE
	LDA #0
	JMP @RETURN
@CHECK_DEBUG_MODE:
	...
	LDA @LOCAL0B
	JSR LOAD_SPRITE_GROUP_PROPERTIES
	STA @VIRTUAL02
	LDY @VIRTUAL04
	LDX NEW_SPRITE_TILE_HEIGHT
	LDA NEW_SPRITE_TILE_WIDTH
	JSL UPLOAD_SPRITE_TO_VRAM
	STA @LOCAL07
@WAIT_SPRITE_UPLOAD:
	LDA @LOCAL07
	CMP #$7FFF
	BGT @WAIT_SPRITE_UPLOAD
	LOADPTR SPRITEMAP_CONFIG_POINTERS, @VIRTUAL06
	LDA @VIRTUAL02
	OPTIMIZED_MULT @VIRTUAL04, 4
	CLC
	ADC @VIRTUAL06
	...
	STA @LOCAL06
@WAIT_SPRITEMAP_ALLOC:
	LDA @LOCAL06
	CMP #$7FFF
	BGT @WAIT_SPRITEMAP_ALLOC
	LDA #1
...
.ENDIF
	...
	LDX @LOCAL07
	LDA @LOCAL06
	JSR LOAD_OVERWORLD_SPRITEMAPS
	LDA @LOCAL0D
	STA @VIRTUAL04
	CMP #$FFFF
	BEQ @INIT_ENTITY_SLOT
	LDA @VIRTUAL04
...
@STORE_SPRITE_DATA:
	...
	ASL
	TAX
	LDA f:SPRITE_VRAM_SLOT_TABLE,X
	CLC
	ADC #$4000
	LDX @LOCAL04
	STA __BSS_START__,X
...
@ADJUST_VRAM_HEIGHT:
	...
	ASL
	TAX
	LDA f:SPRITE_HITBOX_ENABLE_TABLE,X
	LDX @LOCAL04
